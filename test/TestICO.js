const XAPToken = artifacts.require("AppicsToken.sol");
const AppicsICO = artifacts.require("AppicsICO.sol");


contract('AppicsICO', function(accounts) {
